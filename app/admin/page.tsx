                    ...
                    <div className="mx-auto max-w-5xl px-4 md:px-6 pt-6 md:pt-10 pb-4">
                        ...
                        <div className="relative inline-block w-full">
                            ...
                            {!query && (
                                <div
                                    ...
                                    aria-hidden="true"
                                >
                                    <span className="hidden md:inline">[ ⌘K ] | </span>&gt; FILTER INCOMING DOCUMENT
                        ...
                        <div className="mt-6 flex items-center gap-3">
                            ...
                            <span className="text-[9px] md:text-xs font-mono font-medium text-zinc-400 uppercase tracking-widest">
                                {loading ? "LOADING..." : `${filtered.length} REQUESTS_IN_QUEUE`}
                            </span>
                            <div className="h-px flex-1 bg-zinc-200" />
                        </div>
                    </div>
                    ...
                    <div className="mx-auto max-w-5xl py-8 min-h-full flex flex-col">
                        {loading ? (
                            <div className="text-center py-12 flex-1 flex flex-col justify-center">
                                <p className="text-sm font-mono text-zinc-400 uppercase tracking-widest animate-pulse">LOADING_QUEUE...</p>
                            </div>
                        ) : filtered.length === 0 ? (
                            <div className="text-center py-12 flex-1 flex flex-col justify-center">
                                ...
                                {filtered.map((t) => (
                                    <HoverCard key={t.id}>
                                        <div className="flex flex-col md:flex-row md:items-center justify-between p-4 md:px-5 md:py-4 gap-4 md:gap-0">
                                            ...
                                            <button
                                                onClick={() => window.location.href = `/admin/document-view?txId=${t.id}`}
